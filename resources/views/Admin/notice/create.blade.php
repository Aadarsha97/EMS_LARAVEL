...
@section('content')
    <h2 class="text-2xl font-bold p-6">Annonce New Notice</h2>
    ...
    <div class="m-5 p-3">
        <form action="{{ route('notice.store') }}" method="post" class="m-12" enctype="multipart/form-data">
            ...
            <div class="my-2">
                ...
                <textarea id="description" class="block w-full bg-slate-100" type="text" name="description" :value="old('image')"
                    required autofocus>
                </textarea>
